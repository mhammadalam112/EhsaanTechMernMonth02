...
function handleRegistration(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const { error } = payloadValidation_1.authSchema.validate(req.body);
        if (error) {
            const errorInfo = error.details[0].message;
            const errorBoom = boom_1.default.badRequest(errorInfo);
            throw errorBoom;
        }
        const query1 = yield (0, chef_1.getChefByUsername)(userName);
        const query2 = yield (0, foodie_1.getFoodieByUsername)(userName);
        ...
        yield (0, foodie_1.createFoodie)(insertObject);
